 ...
 */
public class SendWifiAps_ThirdActivity extends AppCompatActivity implements DashSpinner.OnDownloadIntimationListener{
    boolean dec;
    long temp=100;
...
//    private boolean isConnected=false;//判断Socket连接是否成功
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WifiManager wifi_service = (WifiManager) SendWifiAps_ThirdActivity.this.getSystemService(WIFI_SERVICE );
...
//                if(isConnected)
    ...
    private void sendFile(String str){
        Socket name = null;
        try {
            name = new Socket(IPAddress, 35000);
//            isConnected=true;
...
//            mDashSpinner.showUnknown();
        ...
        try {
            try {
                    socket= new Socket(IPAddress, 35000);
